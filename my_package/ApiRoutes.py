...
class ApiRoutes(object):
    ...
    def __init__(self):
        load_dotenv()
        self._index_name = os.getenv("PINECONE_INDEX")
    ...
    def create_index(self) -> bool:
        return self.vectorstore.create_index(self._index_name)
    
    def get_sources(self) -> []:
        return self.vectorstore.get_all_source(self._index_name)

    def delete_source(self, source: [str]) -> ([str], [str], [str]):
        return self.vectorstore.delete_data(self._index_name, source)
    ...
    def upload_pdfs(self, pdfs: [str]) -> ([str], [str], [str]):
        ...
        self.save_in_json_file(uploaded, self._history_file)
    ...
    def init_ChatBot(self, openai_model_name) -> bool:
    ...
    def save_in_json_file(self, data: [str], file_path: str) -> bool:
        """
